...
from py.models.GoldModel import GoldModel
warnings.filterwarnings("ignore")

class GoldXGB(GoldModel):
    
    def __init__(self, gold_k):
        super().__init__(gold_k, "XGBoost")
    ...
    def run_model(self, X_train, X_test, y_train, y_test, params):
        with mlflow.start_run(nested=True, run_name=f"XGBoost_gold_model_{params['Test_Size']}_{params['Moving_Avg']}_{params['Lags']}_{params['PCA']}"):
...
xgb = GoldXGB(gold_k=gold.gold_k)
