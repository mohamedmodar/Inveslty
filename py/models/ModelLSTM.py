...
class ModelLSTM(ModelPipeline):
    
    def __init__(self, tag, target):  
        super().__init__(tag, target, "LSTM")
    ...
    def set_grid_search_params(self):
        return {
            "lstm_units": [32],  # Reduced from [32, 64, 128] # [8, 16],
            "dropout_rate": [0.2],  # Reduced from [0.1, 0.2, 0.3]
            "learning_rate": [0.1],  # Reduced from [0.001, 0.01, 0.1]
            "epochs": [50],
            "batch_size": [32]   # Reduced from [16, 32, 64] # [4, 8] 
        }
